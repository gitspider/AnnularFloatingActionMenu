...
/**
 * Created by SunLight on 5/12/2017.
 *
 */
...
public class CircleButton extends LinearLayout {
    ...
    public CircleButton(Context context, AttributeSet attrs) {
        ...
        TypedArray attrsArray = context.obtainStyledAttributes(attrs, R.styleable.RoundButtonsAttrs, 0, 0);
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        mDefaultBackgroundColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_defaultColor, mDefaultBackgroundColor);
        mFocusBackgroundColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_focusColor, mFocusBackgroundColor);
        mDisabledBackgroundColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_disabledColor, mDisabledBackgroundColor);

        mEnabled = attrsArray.getBoolean(R.styleable.RoundButtonsAttrs_android_enabled, true);

        mDisabledTextColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_disabledTextColor, mDisabledTextColor);
        mDisabledBorderColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_disabledBorderColor, mDisabledBorderColor);
        mDefaultTextColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_textColor, mDefaultTextColor);
        // if default color is set then the icon's color is the same (the default for icon's color)
        mDefaultIconColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_iconColor, mDefaultTextColor);

        mDefaultTextSize = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_textSize, mDefaultTextSize);
        mDefaultTextSize = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_android_textSize, mDefaultTextSize);

        mDefaultTextGravity = attrsArray.getInt(R.styleable.RoundButtonsAttrs_rb_textGravity, mDefaultTextGravity);

        mBorderColor = attrsArray.getColor(R.styleable.RoundButtonsAttrs_rb_borderColor, mBorderColor);
        mBorderWidth = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_borderWidth, mBorderWidth);

        mRadius = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_radius, mRadius);
        mFontIconSize = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_fontIconSize, mFontIconSize);

        mIconPaddingLeft = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_iconPaddingLeft, mIconPaddingLeft);
        mIconPaddingRight = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_iconPaddingRight, mIconPaddingRight);
        mIconPaddingTop = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_iconPaddingTop, mIconPaddingTop);
        mIconPaddingBottom = (int) attrsArray.getDimension(R.styleable.RoundButtonsAttrs_rb_iconPaddingBottom, mIconPaddingBottom);

        mTextAllCaps = attrsArray.getBoolean(R.styleable.RoundButtonsAttrs_rb_textAllCaps, false);
        mTextAllCaps = attrsArray.getBoolean(R.styleable.RoundButtonsAttrs_android_textAllCaps, false);

        mGhost = attrsArray.getBoolean(R.styleable.RoundButtonsAttrs_rb_ghost, mGhost);
        mUseSystemFont = attrsArray.getBoolean(R.styleable.RoundButtonsAttrs_rb_useSystemFont, mUseSystemFont);

        String text = attrsArray.getString(R.styleable.RoundButtonsAttrs_rb_text);

        if (text == null) { //no fb_text attribute
            text = attrsArray.getString(R.styleable.RoundButtonsAttrs_android_text);
        }

        mIconPosition = attrsArray.getInt(R.styleable.RoundButtonsAttrs_rb_iconPosition, mIconPosition);

        String fontIcon = attrsArray.getString(R.styleable.RoundButtonsAttrs_rb_fontIconResource);
    ...
    /**
     * Set Icon Position
     * Use the global variables (RoundButton.POSITION_LEFT, RoundButton.POSITION_RIGHT, RoundButton.POSITION_TOP, RoundButton.POSITION_BOTTOM)
     *
    ...
    /**
     * Override setEnabled and rebuild the RoundButton view
    ...
    /**
     * Return Icon Font of the RoundButton
     *
     * @return TextView Object
     */
    ...
    /**
     * Return Icon of the RoundButton
     *
